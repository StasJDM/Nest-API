...
export class UserService {
  ...
  public async findAll(pagination: PaginationDto): Promise<PaginationResponse<ReturnUserDto[]>> {
    const [users, total] = await this.userRepository.findAndCount({ ...pagination.skipTakeOptions });
